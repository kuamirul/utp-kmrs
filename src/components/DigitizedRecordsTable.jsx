...
import { DigitizedRecordContext } from "../services/DigitizedRecordService";


export default function digitizedRecordsTable({ recordType, user, email, userRole }) {

  const { getRecords, recordsList, recordsCount, setRecordType, setUser, departmentOptions, setEmail, setUserRole } = useContext(DigitizedRecordContext);
  ...
  const { saveRecord, adding } = useContext(DigitizedRecordContext);
  ...
  const { deleteRecord } = useContext(DigitizedRecordContext);
  ...
  const { setRows, setFirst, selectedDepartmentVal, setSelectedDepartment } = useContext(DigitizedRecordContext);
