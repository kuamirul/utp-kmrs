...
export default function digitizedRecordsTable({ recordType,user}) {

  const { getRecords, recordsList, recordsCount, setRecordType, setUser } = useContext(DigitizedRecordContext);
  ...
  const { setRows, setFirst } = useContext(DigitizedRecordContext);
